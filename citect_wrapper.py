...
# Config
DEFAULT_INPUT_FOLDER = r"D:\khayyamian\Hamid\data"  # Relative to "Hamid"
TRENDCONVERT_PATH = os.path.join(os.path.dirname(__file__), "trendconvert.py")  # Relative
SHARED_OUTPUT = r'\\WIN-QK1JS7CVQ3C\Users\Administrator\Desktop\Elahi Test'  # VM #2 shared - no local save
